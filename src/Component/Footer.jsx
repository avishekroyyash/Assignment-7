...
const Footer = () => {
    return (
        <div>
             <footer className='bg-[#244D3F] max-w-400 h-[413px] py-10 mx-auto mt-10'>
        <div className='max-w-277.5 h-52.25 mx-auto text-center '>
             <img className='mb-4 mx-auto' src={logxl} alt="logo" />
           ...
           <div className='mt-8 flex items-center justify-between text-[#fafafa99] '>
